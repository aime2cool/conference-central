...
public class Constants {
    public static final String WEB_CLIENT_ID = "95201339574-dh6jbsqiufcahjcnniou8ddv0uk979cr.apps.googleusercontent.com";
...
//    public static final String MEMCACHE_SESSIONS_KEY = "SPEAKER_SESSIONS";
}